...
var iconvLite = __nccwpck_require__(1748);
...
const git = __nccwpck_require__(7607);

const services = {
  appveyor: __nccwpck_require__(1771),
  azurePipelines: __nccwpck_require__(858),
  bamboo: __nccwpck_require__(1827),
  bitbucket: __nccwpck_require__(9794),
  bitrise: __nccwpck_require__(721),
  buddy: __nccwpck_require__(5471),
  buildkite: __nccwpck_require__(5736),
  circleci: __nccwpck_require__(7323),
  cirrus: __nccwpck_require__(5215),
  cloudflarePages: __nccwpck_require__(1841),
  codebuild: __nccwpck_require__(6704),
  codefresh: __nccwpck_require__(9244),
  codeship: __nccwpck_require__(3204),
  drone: __nccwpck_require__(5421),
  github: __nccwpck_require__(7156),
  gitlab: __nccwpck_require__(8332),
  jenkins: __nccwpck_require__(2429),
  netlify: __nccwpck_require__(286),
  puppet: __nccwpck_require__(3865),
  sail: __nccwpck_require__(8214),
  scrutinizer: __nccwpck_require__(8241),
  semaphore: __nccwpck_require__(8933),
  shippable: __nccwpck_require__(9021),
  teamcity: __nccwpck_require__(6569),
  travis: __nccwpck_require__(3622),
  vela: __nccwpck_require__(2769),
  vercel: __nccwpck_require__(4704),
  wercker: __nccwpck_require__(2048),
};
...
const {parseBranch} = __nccwpck_require__(7663);
...
const {prNumber} = __nccwpck_require__(7663);
...
const {head, branch} = __nccwpck_require__(8758);
...
const {head} = __nccwpck_require__(8758);
...
const javaProperties = __nccwpck_require__(8502);
const fromEntries = __nccwpck_require__(8980);

const {branch} = __nccwpck_require__(8758);
...
const mergeStream = __nccwpck_require__(8595);
...
var modules = [
    ...
    __nccwpck_require__(2021),
    __nccwpck_require__(8771),
    __nccwpck_require__(8231),
    __nccwpck_require__(2473),
    __nccwpck_require__(7083),
    __nccwpck_require__(9487),
...
var bomHandling = __nccwpck_require__(4250),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __nccwpck_require__(7585); // Lazy load all encoding definitions.
...
iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
    ...
    var streams = __nccwpck_require__(2281)(stream_module);
...
let convert;
try {
	convert = (__nccwpck_require__(4056)/* .convert */ .C);
} catch (e) {}
...
exports.URL = __nccwpck_require__(9479)["interface"];
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getInputs = exports.getEnvironment = void 0;
...
function getEnvironment() {
    ...
    return {
        displayName: label,
        type: (0, validator_1.processEnvironmentTpe)(slug, type),
    };
}
...
function getInputs() {
    ...
    (0, validator_1.validateInputs)(inputs);
    return inputs;
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getIssueKeys = exports.getCommitMessage = exports.getState = exports.getBranchName = void 0;
const tslib_1 = __nccwpck_require__(1860);
const env_ci_1 = (0, tslib_1.__importDefault)(__nccwpck_require__(4666));
const logger_1 = __nccwpck_require__(7893);
const regex_1 = __nccwpck_require__(6931);
// Using this type as this has the most supported fields
const env = (0, env_ci_1.default)();
function getBranchName() {
    const branchName = env.branch;
    (0, logger_1.getLogger)().debug(`BranchName: ${branchName}`);
    return branchName;
}
...
function getCommitMessage() {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        const commitMessage = process.env.COMMIT_MESSAGE ||
            ...
            undefined;
        (0, logger_1.getLogger)().debug(`CommitMessage: ${commitMessage}`);
...
function getIssueKeys() {
    ...
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const fromInput = (_b = (_a = process.env.JIRA_ISSUES) === null || _a === void 0 ? void 0 : _a.match(regex_1.jiraIssueRegexp)) !== null && _b !== void 0 ? _b : [];
        const fromBranch = (_c = branchName === null || branchName === void 0 ? void 0 : branchName.match(regex_1.jiraIssueRegexp)) !== null && _c !== void 0 ? _c : [];
        const fromCommit = (_d = commitMessage === null || commitMessage === void 0 ? void 0 : commitMessage.match(regex_1.jiraIssueRegexp)) !== null && _d !== void 0 ? _d : [];
        ...
        (0, logger_1.getLogger)().debug(`IssueKeys: "${issueKeys}"`);
        return issueKeys;
    });
}
 ...
 */
const isomorphic_fetch_1 = (0, tslib_1.__importDefault)(__nccwpck_require__(8109));
const logger_1 = __nccwpck_require__(7893);
...
function createApi(options) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const cloudId = yield (0, auth_1.getCloudId)(options.jiraInstance);
        logger.info(`Found cloudId: "${cloudId}"`);
        const securityHandlers = {
            atlassianCloudOauth: (headers) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                headers['Authorization'] = `Bearer ${yield (0, auth_1.getJWT)(options.clientId, options.clientSecret)}`;
                return true;
            }),
        };
        const handleSecurity = (security, headers, params, operationId) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        return {
            ...
            submitBuilds(params, body) {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    const result = yield (0, isomorphic_fetch_1.default)(`${endpoint + basePath}/builds/0.1/cloud/${cloudId}/bulk`, {
                        method: 'POST',
            ...
            deleteBuildsByProperty(params) {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    const result = yield (0, isomorphic_fetch_1.default)(`${endpoint + basePath}/builds/0.1/cloud/${cloudId}/bulkByProperties` +
                        `?${buildQuery({
            ...
            getBuildByKey(params) {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    const result = yield (0, isomorphic_fetch_1.default)(`${endpoint + basePath}/builds/0.1/cloud/${cloudId}/pipelines/${params.pipelineId}/builds/${params.buildNumber}`, {
                        method: 'GET',
                        headers,
                    });
                    logger.debug(`Requesting url: ${result.url}`);
            ...
            storeDevelopmentInformation(params, body) {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    const result = yield (0, isomorphic_fetch_1.default)(`${endpoint + basePath}/devinfo/0.1/cloud/${cloudId}/bulk`, {
                        method: 'POST',
                        headers: Object.assign(Object.assign({}, headers), { 'Content-Type': 'application/json' }),
                        body: JSON.stringify(body),
                    });
            ...
            getRepository(params) {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    const result = yield (0, isomorphic_fetch_1.default)(`${endpoint + basePath}/devinfo/0.1/cloud/${cloudId}/repository/${params.repositoryId}`, {
                        method: 'GET',
                        headers,
                    });
                    logger.debug(`Requesting url: ${result.url}`);
            ...
            deleteByProperties(params) {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    const result = yield (0, isomorphic_fetch_1.default)(`${endpoint + basePath}/devinfo/0.1/cloud/${cloudId}/bulkByProperties` +
                        `?${buildQuery({
                            _updateSequenceId: params._updateSequenceId,
                        })}`, {
                        method: 'DELETE',
            ...
            existsByProperties(params) {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    const result = yield (0, isomorphic_fetch_1.default)(`${endpoint + basePath}/devinfo/0.1/cloud/${cloudId}/existsByProperties` +
                        `?${buildQuery({
                            _updateSequenceId: params._updateSequenceId,
                        })}`, {
                        method: 'GET',
            ...
            deleteEntity(params) {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    const result = yield (0, isomorphic_fetch_1.default)(`${endpoint + basePath}/devinfo/0.1/cloud/${cloudId}/repository/${params.repositoryId}/${params.entityType}/${params.entityId}` +
                        `?${buildQuery({
                            _updateSequenceId: params._updateSequenceId,
                        })}`, {
                        method: 'DELETE',
            ...
            submitDeployments(params, body) {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    const result = yield (0, isomorphic_fetch_1.default)(`${endpoint + basePath}/deployments/0.1/cloud/${cloudId}/bulk`, {
                        method: 'POST',
                        headers: Object.assign(Object.assign({}, headers), { 'Content-Type': 'application/json' }),
                        body: JSON.stringify(body),
                    });
            ...
            deleteDeploymentsByProperty(params) {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    const result = yield (0, isomorphic_fetch_1.default)(`${endpoint + basePath}/deployments/0.1/cloud/${cloudId}/bulkByProperties` +
                        `?${buildQuery({
                            _updateSequenceNumber: params._updateSequenceNumber,
                        })}`, {
                        method: 'DELETE',
            ...
            getDeploymentByKey(params) {
                return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    ...
                    const result = yield (0, isomorphic_fetch_1.default)(`${endpoint + basePath}/deployments/0.1/cloud/${cloudId}/pipelines/${params.pipelineId}/environments/${params.environmentId}/deployments/${params.deploymentSequenceNumber}`, {
                        method: 'GET',
                        headers,
                    });
                    logger.debug(`Requesting url: ${result.url}`);
...
function getJWT(clientId, clientSecret) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        const res = yield (0, isomorphic_fetch_1.default)('https://api.atlassian.com/oauth/token', {
            method: 'POST',
            headers: {
...
function getCloudId(jiraInstance) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        try {
            const res = yield (0, isomorphic_fetch_1.default)(`https://${jiraInstance}.atlassian.net/_edge/tenant_info`);
            const json = yield res.json();
            return json.cloudId;
        }
        catch (err) {
            (0, logger_1.getLogger)().info(err, 'Could not get cloudId, check "jiraInstance" is correct');
            throw err;
        }
    });
}
...
exports.sendBuildInfo = sendBuildInfo;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.sendDeploymentInfo = void 0;
const tslib_1 = __nccwpck_require__(1860);
const logger_1 = __nccwpck_require__(7893);
// eslint-disable-next-line @typescript-eslint/explicit-function-return-type
...
exports.sendDeploymentInfo = sendDeploymentInfo;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.jiraIssueRegexp = void 0;
exports.jiraIssueRegexp = /(\p{L}[\p{L}\d_]+)-(\d+)/gu;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.processEnvironmentTpe = exports.validateInputs = void 0;
...
exports.processEnvironmentTpe = processEnvironmentTpe;
...
const env_ci_1 = (0, tslib_1.__importDefault)(__nccwpck_require__(4666));
const api_1 = (0, tslib_1.__importDefault)(__nccwpck_require__(9840));
const builds_1 = __nccwpck_require__(8735);
const deployments_1 = __nccwpck_require__(2700);
const logger_1 = __nccwpck_require__(7893);
const input_1 = __nccwpck_require__(7936);
const utils_1 = __nccwpck_require__(7733);
function run() {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        try {
            (0, logger_1.setLogger)(console);
            const logger = (0, logger_1.getLogger)();
            // Using this type as this has the most supported fields
            const env = (0, env_ci_1.default)();
            const inputs = (0, input_1.getInputs)();
            const jira = yield (0, api_1.default)(inputs);
            const state = (0, utils_1.getState)();
            const branchName = (0, utils_1.getBranchName)();
            const issueKeys = yield (0, utils_1.getIssueKeys)();
            const common = {
            ...
            switch (inputs.event) {
                case 'build':
                    const build = yield (0, builds_1.sendBuildInfo)(jira, Object.assign(Object.assign({}, common), { branchName, repoUrl: env.slug }));
                    logger.info('Response', build);
                    break;
                case 'deployment':
                    const deployment = yield (0, deployments_1.sendDeploymentInfo)(jira, Object.assign(Object.assign({}, common), { environment: (0, input_1.getEnvironment)() }));
